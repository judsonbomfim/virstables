(function () {
  ...
  var monthlyExpense = {
    ...
    colors: ["var(--theme-default)", "rgba(142, 109, 74, 0.13)", "rgba(142, 109, 74, 0.33)", "rgba(142, 109, 74, 0.62)", "rgba(142, 109, 74, 0.09)"],
    responsive: [
      {
        breakpoint: 1698,
        options: {
  ...
  var projectChart = {
    ...
    colors: ["#8e6d4a", "#838383", "#ffb829", "#65c15c"],
